 ...
 *   <li>{@code parameters} — user-defined parameter name → value bindings</li>
 ...
 * @param parameters user-defined parameter name → value (immutable, may be empty)
...
public record Project(
    ...
    private static final Map<String, Double> EMPTY_PARAMS = Map.of();
    ...
    /**
     * 6-arg constructor without parameters (defaults to empty map).
     */
    public Project(String version, String id, Meta meta, FunctionDefinition function,
                   ParticleSettings particle, RenderSettings render) {
        this(version, id, meta, function, EMPTY_PARAMS, particle, render);
    }

    /**
     * 5-arg constructor without id or parameters (generates id, empty params).
     */
    public Project(String version, Meta meta, FunctionDefinition function,
                   ParticleSettings particle, RenderSettings render) {
        this(version, UUID.randomUUID().toString(), meta, function,
                EMPTY_PARAMS, particle, render);
    }
